...
function toggleDeletions() {
  var deletions = document.querySelectorAll('del'); // Assuming deletions have class 'deletion'
  deletions.forEach(function(deletion) {
    if (deletion.style.display === 'none') {
      deletion.style.display = 'inline'; // Change 'inline' to the appropriate display value
    } else {
      deletion.style.display = 'none'; // Hide deletions
    }
  });
}
